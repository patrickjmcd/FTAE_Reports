...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    NSString *JSONurlString = [NSString stringWithFormat: @"%@%@%@",  @"http://",rubyServer, @":3000/condition_events.json"];
...
-(void)refresh {
    ...
    NSURL *url = [[NSURL alloc] initWithString:@"http://10.41.16.10:3000/events.json"];
    NSURLRequest *request = [[NSURLRequest alloc] initWithURL:url];
